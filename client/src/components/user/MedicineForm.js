            ...
            <div class="bg-gray-200 w-11/12 m-auto my-5 p-6 rounded-lg shadow-lg">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="mb-4">
                            <label for="category"
                                class="block text-sm font-medium text-gray-600  outline-purple-500 ">Medicine
                                Name</label>
                        ...
                        <div class="mb-4">
                            <label for="title" class="block text-sm font-medium text-gray-600">Medicine in stock</label>
                            <h2 type="text" name="title" value="125.78*2.5kg" id="title"
                                class="mt-1 block text-green-700 font-bold w-full border-gray-300 rounded-md shadow-sm">
                                45 pieces</h2>
                        ...
                        <div class="mb-4">
                            <label for="title" class="block text-sm font-medium text-gray-600">Request Medicine</label>
